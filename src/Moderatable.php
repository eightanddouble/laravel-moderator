...
trait Moderatable
{
    ...
    {
        return defined('static::MODERATION_STATUS') ? static::MODERATION_STATUS : config('moderator.status_column');
    }
    ...
    {
        return defined('static::MODERATED_AT') ? static::MODERATED_AT : config('moderator.moderated_at_column');
    }
    ...
    {
        return defined('static::MODERATED_BY') ? static::MODERATED_BY : config('moderator.moderated_by_column');
    }
